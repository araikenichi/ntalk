...
export const TranslateIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M5 8l6 6"/><path d="M4 14l6-6 2-3"/><path d="M2 5h12"/><path d="M7 2h1"/><path d="M22 22l-5-10-5 10"/><path d="M14 18h6"/></svg>
);
...
export const LiveCameraIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M23 7l-7 5 7 5V7z" fill="currentColor"></path>
    <rect x="1" y="5" width="15" height="14" rx="2" ry="2" fill="currentColor"></rect>
    <text x="8.5" y="13" fontSize="5" textAnchor="middle" fill="none" stroke="#4B5563" strokeWidth="0.5" fontWeight="300">LIVE</text>
  </svg>
);
