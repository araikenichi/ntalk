...
import { User, Post, PostType, Comment, Conversation, DirectMessage, Community, Opportunity, Product, ProductCondition, ProductStatus, Order, OrderStatus } from './types';
...
export const mockProducts: Product[] = [
    {
        ...
        description: '9成新iPhone 14 Pro，无划痕，功能完好。因换新机出售，配原装充电器和耳机。支持面交验货。',
        price: 5999,
        originalPrice: 7999,
        images: [
            'https://picsum.photos/seed/iphone1/800/800',
            'https://picsum.photos/seed/iphone2/800/800',
            'https://picsum.photos/seed/iphone3/800/800',
        ],
        category: '数码产品',
        ...
        likes: 89,
        createdAt: '2小时前',
        shippingOptions: ['自提', '顺丰包邮'],
        tags: ['手机', 'iPhone', '苹果'],
    },
    {
        id: 'prod2',
        title: 'MacBook Air M2 2023款 银色',
        description: '全新未拆封MacBook Air，M2芯片，8GB内存，256GB存储。公司年会中奖，本人已有笔记本，诚心转让。',
        price: 8499,
        originalPrice: 9499,
        images: [
        ...
        likes: 156,
        createdAt: '1天前',
        shippingOptions: ['顺丰到付', '自提'],
        tags: ['笔记本', 'MacBook', '苹果', '全新'],
    },
    {
        id: 'prod3',
        title: 'Sony WH-1000XM5 降噪耳机',
        description: '使用3个月，95新。音质完美，降噪效果一流。配齐所有配件和包装盒。仅限同城面交。',
        price: 1899,
        originalPrice: 2499,
        images: [
            'https://picsum.photos/seed/sony1/800/800',
            'https://picsum.photos/seed/sony2/800/800',
            'https://picsum.photos/seed/sony3/800/800',
        ],
        category: '数码配件',
        condition: ProductCondition.LikeNew,
        status: ProductStatus.Available,
    ...
    },
    {
        ...
        description: '自用Switch OLED，成色很新，配2个手柄和3款游戏卡带（塞尔达、马里奥、健身环）。',
        price: 2199,
        images: [
            'https://picsum.photos/seed/switch1/800/800',
            'https://picsum.photos/seed/switch2/800/800',
        ],
        category: '游戏设备',
        ...
        likes: 98,
        createdAt: '5天前',
        shippingOptions: ['快递到付', '自提'],
        tags: ['游戏机', 'Switch', '任天堂'],
    },
    {
        id: 'prod5',
        title: 'iPad Pro 11寸 2022款 256GB',
        description: '配Apple Pencil二代和妙控键盘。用于绘画和办公，功能完好。因升级新款出售。',
        price: 5299,
        originalPrice: 7299,
        images: [
        ...
        likes: 112,
        createdAt: '1周前',
        shippingOptions: ['顺丰包邮', '自提'],
        tags: ['平板', 'iPad', '苹果', '绘画'],
    },
    {
        id: 'prod6',
        title: 'Canon EOS R6 全画幅相机',
        description: '单机身，快门数3000次不到。配2块原装电池和相机包。摄影爱好者升级设备出售。',
        price: 12999,
        images: [
            'https://picsum.photos/seed/canon1/800/800',
            'https://picsum.photos/seed/canon2/800/800',
        ],
        category: '摄影器材',
        condition: ProductCondition.LikeNew,
        status: ProductStatus.Available,
        ...
        likes: 67,
        createdAt: '2天前',
        shippingOptions: ['自提', '顺丰到付'],
        tags: ['相机', 'Canon', '全画幅'],
    },
    {
        id: 'prod7',
        title: 'Herman Miller Aeron 人体工学椅',
        description: '经典办公椅，使用1年，9成新。搬家清仓，仅限北京同城自提。',
        price: 3999,
        originalPrice: 8999,
        images: [
    ...
    },
    {
        ...
        description: '多出来的一副，全新未拆封，支持验货。价格比官网便宜。',
        price: 1499,
        originalPrice: 1899,
        images: [
        ...
        createdAt: '1天前',
        shippingOptions: ['顺丰包邮', '自提'],
        tags: ['耳机', 'AirPods', '苹果', '全新'],
    },
    {
        id: 'prod9',
        title: 'PS5 光驱版 + 2个手柄',
        description: '港版PS5，配2个无线手柄和5款游戏光盘。因工作忙碌出售，成色很新。',
        price: 3299,
        images: [
            'https://picsum.photos/seed/ps5-1/800/800',
            'https://picsum.photos/seed/ps5-2/800/800',
            'https://picsum.photos/seed/ps5-3/800/800',
        ],
        category: '游戏设备',
        condition: ProductCondition.Good,
    ...
    },
    {
        ...
        description: '飞行时间不到10小时，配3块电池和收纳包。功能完好，适合航拍爱好者。',
        price: 4299,
        originalPrice: 5299,
        images: [
            'https://picsum.photos/seed/dji1/800/800',
            'https://picsum.photos/seed/dji2/800/800',
        ],
        category: '摄影器材',
        condition: ProductCondition.LikeNew,
        status: ProductStatus.Available,
...
export const mockOrders: Order[] = [
    {
        id: 'order1',
        orderNumber: 'ORD20231026001',
        buyer: users.li,
        seller: users.emily,
        product: mockProducts[8], // PS5
        quantity: 1,
        totalPrice: 3299,
        status: OrderStatus.Completed,
        shippingAddress: '上海市浦东新区张江高科技园区123号',
        shippingMethod: '自提',
    ...
    {
        id: 'order2',
        orderNumber: 'ORD20231026002',
        buyer: users.sato,
        seller: users.li,
        product: mockProducts[0], // iPhone
        quantity: 1,
        totalPrice: 5999,
        status: OrderStatus.Shipped,
        shippingAddress: '东京都涩谷区道玄坂1-2-3',
        shippingMethod: '顺丰包邮',
