...
export const users: { [key: string]: User } = {
  sato: {
    ...
    followerCount: 2300,
    postCount: 98,
    nativeLanguages: [{ code: 'ja', name: '日本語', level: 'native' }],
    learningLanguages: [{ code: 'en', name: 'English', level: 'advanced' }],
  },
  li: {
    id: 'u2',
    name: 'Li Wei',
    ...
    learningLanguages: [{ code: 'en', name: 'English', level: 'intermediate' }, { code: 'ja', name: '日本語', level: 'beginner' }],
  },
  emily: {
    id: 'u3',
    name: 'Emily Carter',
    ...
    followerCount: 12000,
    postCount: 123,
    nativeLanguages: [{ code: 'en', name: 'English', level: 'native' }],
    learningLanguages: [{ code: 'zh', name: '中文', level: 'beginner' }, { code: 'ja', name: '日本語', level: 'beginner' }],
  },
  chen: {
    id: 'u4',
    name: 'Chen Yue',
    ...
    postCount: 250,
    nativeLanguages: [{ code: 'zh', name: '中文', level: 'native' }],
    learningLanguages: [{ code: 'en', name: 'English', level: 'intermediate' }, { code: 'ko', name: '한국어', level: 'beginner' }],
  },
};
